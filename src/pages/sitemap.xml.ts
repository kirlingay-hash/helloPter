...
export const GET: APIRoute = async () => {
  ...
  const urls = [
    ...
    { loc: toAbsoluteUrl('/editorial-policy.html'), lastmod: undefined },
    { loc: toAbsoluteUrl('/privacy-policy.html'), lastmod: undefined },
    { loc: toAbsoluteUrl('/disclaimer.html'), lastmod: undefined },
